...
import landVid from '../Assests/landVid.mp4'
...
const Landing_page = () => {
  ...
  return (
    <div id='Logo' className='md:min-h-screen overflow-hidden mb-10 md:mb-0'>
        ...
        <video ref={imgref} className='z-[-10] md:z-10 md:absolute right-16 top-[147px] w-[330px] md:rounded-s-none rounded-lg mx-auto mt-5 md:mt-0 md:w-[800px] img1 ' controls autoPlay width={900} src={landVid} alt=''/>
